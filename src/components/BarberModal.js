...
export default ({show, setShow, user, service}) => {
    ...
    useEffect(()=>{
        let today = new Date();
        setSelectedYear( today.getFullYear() ); //setando Ano Atual
        setSelectedMonth( today.getMonth() ); //setando o mês Atual
        setSelectedDay( today.getDate() ); //setando o dia Atual
    }, []);
                            ...
                            {listDays.map((item, key)=>(
                                <DateItem 
                                    ...
                                    style={{
                                        ...
                                        backgroundColor: item.number === selectedDay ? '#000' : '#fff'
                                    }}
                                >
                                    <DateItemWeekDay
                                        style={{
                            ...
                            <TimeList horizontal={true} showHorizontalScrollIndicator={false}>
                                {listHours.map((item, key)=>(
                                    <TimeItem
                                        ...
                                        style={{
                                            backgroundColor: item === selectedHour ? '#000' : '#fff'
